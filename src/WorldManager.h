...
public:
    ...
    WorldManager(int WINDOW_WIDTH, int WINDOW_HEIGHT, const char* path_to_font = nullptr, bool fpsCorrection = false, int fullscreenScale = 1, float move_speed = 10, float zoom_speed = 0.03);
    ~WorldManager();
